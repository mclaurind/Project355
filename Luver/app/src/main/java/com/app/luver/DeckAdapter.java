...
public class DeckAdapter extends BaseAdapter {
    ...
    private ArrayList<QuestionModal> questionData;
    private Context context;

    // on below line we have created constructor for our variables.
    public DeckAdapter(ArrayList<QuestionModal> courseData, Context context) {
        this.questionData = courseData;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ((TextView) v.findViewById(R.id.idTVQuestionNum)).setText(questionData.get(position).getQuestionNum());
        ((TextView) v.findViewById(R.id.idTVQuestion)).setText(questionData.get(position).getQuestion());
        ((ImageView) v.findViewById(R.id.idIVCover)).setImageResource(questionData.get(position).getImgId());
        return v;
    }
}
